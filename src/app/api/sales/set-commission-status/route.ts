...
const MIGRATIONS: Array<{ id: string; commissionStatus: CommissionStatus; reservationId: string }> = [
  // INV2388876 — ya cobradas ($1.103.000 pagado)
  ...
  // INV2418113 — facturadas, pago ~11 jun ($402.000)
  ...
  // Ciclo siguiente — pendientes (facturar ~18 jun, cobro ~25 jun)
  { id: "295106346400", commissionStatus: "pendiente", reservationId: "295106346400" },
  { id: "24879346400",  commissionStatus: "pendiente", reservationId: "24879346400"  },
  { id: "126491346400", commissionStatus: "pendiente", reservationId: "126491346400" },
  { id: "456178346400", commissionStatus: "pendiente", reservationId: "456178346400" },
  { id: "855156346600", commissionStatus: "pendiente", reservationId: "855156346600" },
  { id: "336052346800", commissionStatus: "pendiente", reservationId: "336052346800" },
  { id: "739384346800", commissionStatus: "pendiente", reservationId: "739384346800" },
  { id: "719840347200", commissionStatus: "pendiente", reservationId: "719840347200" },

  // Viaclub — pendiente (cobro jue 29 may)
